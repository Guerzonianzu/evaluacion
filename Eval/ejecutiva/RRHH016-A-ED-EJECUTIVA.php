<?php
    ...
    if($_SESSION['rol'] == 2){ 
        ...
        <head>
            ...
            <title>RRHH016-A-ED-EJECUTIVA</title>
        ...
        <body>
            ...
            <div class="container">
                <div class="row">
                    <h1><b>EVALUACIÓN DE DESEMPEÑO DIRECCIÓN EJECUTIVA - AUXILIARES ADMINISTRATIVOS/AS</b></h1>
                ...
                <form method="POST">
                    ...
                    <input type="submit" value="Enviar" class="bt btn-primary">
                </form>
