<?php
    ...
    if($_SESSION['rol'] == 2){ 
        ...
        <head>
            ...
            <title>RRHH016-AASIST-ED-EJECUTIVA</title>
        ...
        <body>
            ...
            <div class="container">
                <div class="row">
                    <h1><b>EVALUACIÓN DE DESEMPEÑO DIRECCIÓN EJECUTIVA - AUXILIARES ASISTENCIALES</b></h1>
                ...
                <form method="POST">
                    ...
                    <div class="row">
                        <input class='form-check-input mt-2 ml-3' type='radio' name='op7' value="15" required><label for="" style="margin-left:40px"><b>Excelente</b></label>
                    </div>
                    <div class="row">
                        <input class='form-check-input mt-2 ml-3' type='radio' name='op7' value="12" required><label for="" style="margin-left:40px"><b>Muy Bueno</b></label>
                    </div>
                    <div class="row">
                        <input class='form-check-input mt-2 ml-3' type='radio' name='op7' value="9" required><label for="" style="margin-left:40px"><b>Bueno</b></label>
                    </div>
                    <div class="row">
                        <input class='form-check-input mt-2 ml-3' type='radio' name='op7' value="6" required><label for="" style="margin-left:40px"><b>Regular</b></label>
                    </div>
                    <div class="row">
                        <input class='form-check-input mt-2 ml-3' type='radio' name='op7' value="3" required><label for="" style="margin-left:40px"><b>Deficiente</b></label>
                    </div>
