<?php
    ...
    if($_SESSION['rol'] == 2){ 
        ...
        <head>
            ...
            <title>RRHH016-A-ED-INFRAESTRUCTURA</title>
        ...
        <body>
            ...
            <div class="container">
                <div class="row">
                    <h1><b>EVALUACIÓN DE DESEMPEÑO DIRECCIÓN DE INFRAESTRUCTURA - AUXILIARES ADMINISTRATIVOS/AS</b></h1>
                ...
                <form method="POST">
                    ...
                    <div class="row">
                        <h3>6.	MANEJO DE HERRAMIENTAS E INSTRUMENTACIÓN ESPECÍFICAS: Habilidad para manejar e instrumentar herramientas tecnológicas para reparación o instalación de equipos, o instrumentar procesos para lo anterior.</h3>
                    </div>
                    <div class="row">
