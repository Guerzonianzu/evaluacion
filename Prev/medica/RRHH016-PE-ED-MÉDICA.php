            ...
            <div class="container">
                ...
                <?php
                    if(isset($_POST['op7'])){
                        ...
                        $pregunta7 = $_POST['op7'];
                        $pregunta8 = 0;
                        $sql = "insert into evaluaciones(evaluado, pregunta1,pregunta2,pregunta3, pregunta4, pregunta5, pregunta6, pregunta7, pregunta8, evaluador, rehacer) values ($id, $pregunta1, $pregunta2, $pregunta3, $pregunta4, $pregunta5, $pregunta6, $pregunta7, 0, $_SESSION[id], 0);";
                        mysqli_query($c, $sql);
                    }
                ?>
            </div>
